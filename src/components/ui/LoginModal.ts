        ...
        <div class="p-6">
          ...
          <form id="loginForm" class="space-y-4">
            ...
            <div class="text-center pt-2">
              ...
              >
                Â¿No tienes cuenta? <span class="text-primary-600 dark:text-primary-400">RegÃ­strate</span>
              </button>
            </div>
          </form>
          ...
          <form id="registerForm" class="space-y-4 hidden">
            ...
            <div class="text-center pt-2">
              <button
                ...
                class="text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200 transition-colors"
              >
                Â¿Ya tienes cuenta? <span class="text-primary-600 dark:text-primary-400">Inicia sesiÃ³n</span>
              </button>
            </div>
          </form>
        </div>
