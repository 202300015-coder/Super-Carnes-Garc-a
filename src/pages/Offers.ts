...
export function renderOffers() {
  ...
  return `
    <div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8">
      ...
      <!-- Banner de Ofertas -->
      <div class="bg-gradient-to-r from-primary-600 to-primary-800 dark:from-primary-700 dark:to-primary-900 rounded-lg p-4 sm:p-6 mb-4 sm:mb-8 text-white">
        <h2 class="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">¡Grandes Descuentos!</h2>
        <p class="text-sm sm:text-base text-primary-100 dark:text-primary-200">Aprovecha nuestras ofertas especiales. Solo productos con descuento activo.</p>
      </div>
